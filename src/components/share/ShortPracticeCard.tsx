    ...
    <div className="w-full rounded-2xl border border-gray-800 bg-[#11151d] p-4 text-white shadow-lg">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
        ...
        <div className="flex-1">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-4 text-sm">
            ...
            <span className="flex items-center gap-1 text-gray-300">
              {" "}
              <span className="text-lime-400">◷</span> {practice.duration}{" "}
              min{" "}
            </span>{" "}
            <span className="flex items-center gap-1 text-gray-300">
              {" "}
            ...
            <span className="flex items-center gap-1 text-gray-300">
              {" "}
              <span className="text-yellow-400">★</span> {practice.rating}{" "}
            </span>{" "}
          </div>{" "}
        </div>{" "}
        {/* View Details */}{" "}
        <Link
          ...
          className="rounded-full border border-gray-600 px-5 py-2 text-center text-sm font-medium transition hover:border-lime-400 hover:text-lime-400"
        >
          {" "}
          View Details{" "}
        </Link>{" "}
        {/* Mark as Done */} <Button /> {/* Delete Button */}{" "}
        <button
